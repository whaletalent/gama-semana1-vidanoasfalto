...
class Article5 extends Component {
    ...
    render() {
        ...
        return (
            <Fragment>
                <MetaTags>
                    <title>5 Passos para Vender seu Carro acima da Tabela FIPE</title>
                    <meta id="meta-description" name="description" content="Aqui vão algumas dicas para conseguir vende-lo no melhor preço" />
                    <meta id="og-title" property="og:title" content="5 Passos para Vender seu Carro acima da Tabela FIPE" />
